  ...
  return (
    <div className="fixed inset-0 bg-[#050505] flex flex-col">
      ...
      <button
        ...
        className="absolute top-4 right-4 p-3 text-[#636363] hover:text-[#B0B0B0] transition-colors z-10"
      >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        {/* Logo */}
        <div className="w-28 h-28 rounded-3xl bg-[#10B981]/10 border border-[#10B981]/20 flex items-center justify-center mb-8 animate-pulse p-4">
          <img
        ...
        <div className="text-center mb-4">
          <div className="flex items-baseline justify-center">
            <span className="text-8xl font-bold text-[#F1F1F1] tracking-tight">{time}</span>
            <span className="text-3xl font-medium text-[#636363] ml-2">{ampm}</span>
          </div>
        </div>

        {/* Alarm label */}
        <p className="text-[#636363] text-lg mb-16">Wake Up!</p>
      </div>
      ...
      <div className="px-6 pb-12">
        ...
        >
          ...
          >
            <span className="text-[#34D399] font-medium">Dismiss</span>
        ...
        {/* Hint text */}
        <p className="text-center text-[#636363] text-sm mt-4">
