    ...
    return (
      <div className="flex flex-col min-h-full px-6 py-8 bg-[#050505]">
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[#737373] max-w-sm mx-auto mb-6">
    ...
    return (
      <div className="flex flex-col min-h-full px-6 py-8 bg-[#050505]">
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[#737373] max-w-sm mx-auto mb-2">
  ...
  return (
    <div className="flex flex-col min-h-full px-6 py-8 bg-[#050505]">
      ...
      <div className="space-y-3 pt-6">
        <button
          onClick={handleDownload}
          className="w-full py-4 px-6 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 active:bg-red-800 transition-colors flex items-center justify-center gap-2"
        >
