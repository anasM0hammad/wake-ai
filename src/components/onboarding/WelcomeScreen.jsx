      ...
      <div className="space-y-4 mb-10 text-left max-w-sm">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Answer questions to prove you're awake before the alarm stops</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Emergency code to instantly stop the alarm when needed</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">On-device AI means no internet needed when waking up</p>
          </div>
        </div>
      </div>
