export default function AlarmFailure({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-red-900 via-rose-900 to-red-900 flex flex-col">
      {/* Main content */}
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        {/* Failure icon */}
        <div className="w-32 h-32 rounded-full bg-red-500/20 flex items-center justify-center mb-8">
        ...
        {/* Subtitle */}
        <p className="text-red-200/80 text-center text-lg mb-8">
          {subtitle}
        </p>
          ...
          <div className="bg-white/10 rounded-2xl p-6 w-full max-w-sm mb-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                ...
                <div className="text-red-300/60 text-xs mt-1">Questions</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400">
                  {stats.questionsCorrect}
                </div>
                <div className="text-red-300/60 text-xs mt-1">Correct</div>
              </div>
            </div>
          </div>
        )}
        ...
        {/* Tip */}
        <div className="bg-white/5 rounded-xl p-4 w-full max-w-sm">
      ...
      <div className="px-6 pb-8">
        <button
          onClick={onClose}
          className="w-full py-4 px-6 bg-white/10 text-white font-semibold rounded-xl hover:bg-white/20 transition-colors"
        >
          Dismiss
        </button>
      </div>
