  ...
  return (
    <div className="fixed inset-0 bg-[#050505] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        {/* Failure icon */}
        <div className="w-32 h-32 rounded-full bg-red-600/20 flex items-center justify-center mb-8">
          <div className="w-24 h-24 rounded-full bg-red-600/30 flex items-center justify-center">
        ...
        {/* Subtitle */}
        <p className="text-[#E5E5E5] text-center text-lg mb-8">
          {subtitle}
        </p>

        {/* Stats */}
        {stats && (
          <div className="bg-[#0C0C0C] border border-[#1F1F1F] rounded-2xl p-6 w-full max-w-sm mb-6">
        ...
        {/* Tip */}
        <div className="bg-[#0C0C0C] border border-[#1F1F1F] rounded-xl p-4 w-full max-w-sm">
          <div className="flex items-start gap-3">
            <svg className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
            <p className="text-[#737373] text-sm">{tip}</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 pb-8">
        <button
          onClick={onClose}
          className="w-full py-4 px-6 bg-[#141414] border border-[#262626] text-white font-semibold rounded-xl hover:bg-[#1F1F1F] transition-colors"
        >
          Dismiss
        </button>
      </div>
