  ...
  return (
    <div className="flex flex-col min-h-full px-6 py-8 bg-[#09090B]">
      <div className="flex-1">
        ...
        <div className="bg-sky-900/20 border border-sky-700/30 rounded-xl p-4 mb-6">
      ...
      <div className="space-y-3 pt-6">
        <button
          onClick={handleDownload}
          className="w-full py-4 px-6 bg-sky-500 text-white font-semibold rounded-xl hover:bg-sky-600 active:bg-sky-700 transition-colors flex items-center justify-center gap-2"
        >
